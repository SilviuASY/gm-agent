...
export const harkanABI = [{ inputs: [{ internalType: "string", name: "gameId", type: "string" }, { internalType: "string", name: "action", type: "string" }, { internalType: "uint256", name: "value", type: "uint256" }, { internalType: "uint256", name: "randomNums", type: "uint256" }, { internalType: "uint256", name: "maxInt", type: "uint256" }], name: "recordActionWithRandom", outputs: [], stateMutability: "nonpayable", type: "function" }] as const;
export const redButtonABI = [{ inputs: [{ internalType: "uint8", name: "_gachaTypeIndex", type: "uint8" }, { internalType: "uint256", name: "_deadline", type: "uint256" }, { internalType: "bytes", name: "_permitSig", type: "bytes" }], name: "drawItem", outputs: [], stateMutability: "nonpayable", type: "function" }] as const;
export const gmBoostABI = [{ inputs: [], name: "onChainGM", outputs: [], stateMutability: "payable", type: "function" }] as const;
